...
#define LIBRARY_PATH "/usr/local/lib/ImageMagick-7.0.5/"

/* Subdirectory of lib where ImageMagick architecture dependent files are
   installed. */
#define LIBRARY_RELATIVE_PATH "ImageMagick-7.0.5"
...
#define PACKAGE_STRING "ImageMagick 7.0.5-9"
...
#define PACKAGE_VERSION "7.0.5-9"
